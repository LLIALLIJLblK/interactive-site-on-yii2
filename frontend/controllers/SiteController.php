...
class SiteController extends Controller
{
    ...
    public function actionCalculator()
    {
        ...
        if(empty(Yii::$app->request->post()) === false){           
            ...
            $result = $prices[$form->raw_types][$form->month][$form->tonnage];
            echo $result ." ". $form->raw_types . " ". $form->tonnage . " ". $form->month. PHP_EOL;
            ...
            $response = array(
                "result" => $result,
                "price_list"=>$prices[$form->raw_types]
            );
        } 
    ...
    public function actionRequestPasswordReset()
    {
        ...
        if ($model->load(Yii::$app->request->post()) && $model->validate()) {
            if ($model->sendEmail()) {
                ...
                return $this->redirect(['last/last']);
                //return $this->goHome();
            }
